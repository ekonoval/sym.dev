...
class Product
{
     ...
     * Set category
     *
     * @param \Acme\EssentialsBookBundle\Entity\Category $category
     * @return Product
     */
    public function setCategory(\Acme\EssentialsBookBundle\Entity\Category $category = null)
    {
     ...
     * Get category
     *
     * @return \Acme\EssentialsBookBundle\Entity\Category 
     */
